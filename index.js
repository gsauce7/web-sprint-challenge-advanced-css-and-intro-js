...
/* NOTE: the 20th century is from 1900 - 1999, not 2000! So my code reflects that. -Gabriel*/
function get20s(artists){
  let result = [];
  for (let i = 0; i < artists.length; i++){
    let artist = artists[i];
    let lifetime = artist.years.split(" - ");
    let startCentury = Number(lifetime[0].substring(0, 2));
    let endCentury = Number(lifetime[1].substring(0, 2));
...
/*After further study, THIS is much better:  */
function get20sBETTER(array) {
	let newArr = [];
...
console.log(get20sBETTER(artists));
...
/*** This one needs to be commented out for Task 6 to work properly ***/ 
...
addArtist(artists, {"id": 20,
    "name": "Gabriel Henton",
    "years": "1980 - current day",
    "genre": "Impressionism",
    "nationality": "American",
    "bio": "I was born in 1980 and enjoy life and helping other people! Lorem ipsum dolor sit amicus ditaem."}
    );
